package com.entransys.controller;
...
import com.entransys.service.EmployeeService;
...
public class EmployeeController {
	@Autowired
	 ...
	 @RequestMapping(value = "/employeee", method = RequestMethod.GET, produces = "application/json")
